...
`./vendor/bin/phpunit`: This command runs PHPUnit, a testing framework for PHP. It will execute all unit tests in the project and report the results.

`php bin/console app:process-currency public/input.txt`: This command executes the processCurrencyDataFromFile method in the ExchangerService class, passing the file path public/input.txt as a parameter.
